            ...
            <tr height="40">
               ...
               <td width="310" align="left">
               		...
               		<c:if test="${bean.re_step > 1}">
                  		...
                  		<a href="MemberCheckCon.do?num=${bean.num}&check=4">${bean.subject}</a>
 					</td>
         ...
         <p align="center">
            ...
            <c:if test="${count > 0}">
				...
				<c:if test="${startPage > 10}">
					<a class="btn btn-sm btn-info" href='BoardListCon3.do?pageNum=${startPage -10}'>[이전] </a>
				</c:if>
				
				<!-- 페이징 처리 -->
				<c:forEach var="i" begin="${startPage}" end="${endPage}">
					<a href='BoardListCon3.do?pageNum=${i}'>[${i}]</a>
				</c:forEach>
				
				<!-- 다음이라는 링크를 만들건지 파악 -->
				<c:if test="${endPage < pageCount}">
					<a class="btn btn-sm btn-info" href='BoardListCon3.do?pageNum=${startPage +10}'>[다음]</a>
				</c:if>
            </c:if>
            </p>
            </div>
