...
<%-- <jsp:include page="../footer.jsp" flush="false"/> --%>
   <div class="container">
      <div class="table-response">
      	<div class="title">
         <h2 align="center"><%=session.getAttribute("recipe") %></h2>
        </div>
         <div align="right">
            <button type="button" class="btn btn-sm btn-info" id="main"
               onclick="location.href='../index2.jsp'">메인으로</button>
            <button type="button" class="btn btn-sm btn-info" id="main"
               onclick="location.href='Board2/AdminCheck2.jsp'">글쓰기</button>
         </div>
		 <p>&nbsp;</p>
         ...
         <table class="table table-hover table-md">
            ...
            <thead>
               <tr>
                  <th>NO</th>
                  <th>제목</th>
                  <th style="text-align:center;">레시피 종류</th>
                  <th>작성자</th>
                  <th>작성일</th>
                  <th>조회수</th>
               </tr>
            ...
            <tr height="40">
               ...
               <td width="310" align="left">
               		...
               		<c:if test="${bean.re_step > 1}">
                  		...
                  		<a href="MemberCheckCon.do?num=${bean.num}&check=0">${bean.subject}</a>
 					</td>
 					
               <td width="30" align="center">${bean.kind}</td>
         ...
         <p align="center">
            ...
            <c:if test="${count > 0}">
				...
				<c:if test="${startPage > 10}">
					<a class="btn btn-sm btn-info" href='BoardListCon2.do?pageNum=${startPage -10}'>[이전] </a>
				</c:if>
				
				<!-- 페이징 처리 -->
				<c:forEach var="i" begin="${startPage}" end="${endPage}">
					<a href='BoardListCon2.do?pageNum=${i}'>[${i}]</a>
				</c:forEach>
				
				<!-- 다음이라는 링크를 만들건지 파악 -->
				<c:if test="${endPage < pageCount}">
					<a class="btn btn-sm btn-info" href='BoardListCon2.do?pageNum=${startPage +10}'>[다음]</a>
				</c:if>
            </c:if>
            </p>
            </div>
