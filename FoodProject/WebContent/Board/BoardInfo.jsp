							...
							<tr>
								...
								<td class="text-center" align="center" colspan="4">
									<button class="btn btn-info btn-sm"
										onclick="location.href='BoardReWriteCon.do?num=${bean.num }&ref=${bean.ref }&re_step=${bean.re_step}&re_level=${bean.re_level}'">답글쓰기</button>
									...
									%>
									<button class="btn btn-info btn-sm"
										onclick="location.href='../BoardUpdateCon.do?num=${bean.num}'">수정하기</button>
									<button class="btn btn-info btn-sm"
										onclick="location.href='../BoardDeleteCon.do?num=${bean.num}'">삭제하기</button>
									<%
										}
										}
									%>
									<button class="btn btn-info btn-sm"
										onclick="location.href='../BoardListCon.do'">목록보기</button>
								</tr>
							</table>
					</div>
				</div>
