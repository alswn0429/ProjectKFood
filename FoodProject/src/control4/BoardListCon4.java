...
@WebServlet("/BoardListCon4.do")
public class BoardListCon4 extends HttpServlet {
	...
	protected void reqProc(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Vector<BoardBean4> vec = dbao.getAllBoard(startRow , endRow);
		...
		RequestDispatcher dis = request.getRequestDispatcher("Board4/BoardList4.jsp");
