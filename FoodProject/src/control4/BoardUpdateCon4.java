...
@WebServlet("/BoardUpdateCon4.do")
public class BoardUpdateCon4 extends HttpServlet {
	...
	protected void reqProc(HttpServletRequest request, HttpServletResponse response)
		...
		RequestDispatcher dis = request.getRequestDispatcher("Board4/BoardUpdateForm4.jsp");
