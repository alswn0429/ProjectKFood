...
public class BoardDAO {
	...
	public void insertBoard(BoardBean bean) {
		...
		try {
			...
			String refsql = "select max(ref) from board";	//ref의 값중 가장 큰값을 리턴해주세요
			...
			String sql = "insert into board values(board_seq.NEXTVAL,?,?,?,?,sysdate,?,?,?,0,?)";	//board_seq.NEXTVAL(시퀀스)시퀀스에 들어가있는 값의 다음값을 넣어준다
